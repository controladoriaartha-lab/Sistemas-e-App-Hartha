        ...
        <Card className="p-4">
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            <div>
              ...
              <p className="mt-1 text-[21px] text-muted-foreground">sessões</p>
            </div>
            <div>
              <p className="font-display text-3xl tabular-nums leading-none">
                {formatDuration(stats.week.minutes)}
              </p>
              <p className="mt-1 text-[21px] text-muted-foreground">em treino</p>
            </div>
          </div>
  ...
  return (
    <Card className="p-4">
      ...
      <div className="mt-3 grid grid-cols-2 gap-3 text-[24px]">
        ...
        <div>
          <p className="text-[18px] uppercase tracking-widest text-faint">{rightLabel}</p>
